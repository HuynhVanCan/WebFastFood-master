...
namespace VSLT_FastfoodTeam.Controllers
{
    public class GioHangController : Controller
    {
        ...
        {
            bool result = false;           
            result = SendEmail("canhuynh2k1@gmail.com", "Kính Chào Qúy Khách", "<p> Hi bạn!!!<br />Chúng tôi sẽ giao hàng nhanh nhất có thể vui lòng chuẩn bị tiền mặt!!!!<br />Cảm ơn bạn đã đặt hàng của chúng tôi!!! <br />Have a nice day</p>");
